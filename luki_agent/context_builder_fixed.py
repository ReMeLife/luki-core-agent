...
# Simple token counter to avoid tiktoken dependency until environment is set up
...
class ContextBuilder:
    ...
    def _assemble_context(self, chunks: List[ContextChunk], user_input: str, retrieval_results: Optional[List[Dict[str, Any]]]) -> ContextBuildResult:
        ...
        available_tokens = self.max_context_tokens - user_input_tokens - 500
        ...
        for chunk in final_chunks:
            ...
            layer_breakdown[chunk.layer] = chunk.token_count
